...
<main>
    <form:form method="post" action="${pageContext.request.contextPath}/web/articles" novalidate="true" modelAttribute="articleRequest">
        <div>
        ...
        <div>
            <button type="button" onclick="location.href='${pageContext.request.contextPath}/web/articles'">
                Отменить
            </button>
